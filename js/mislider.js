  ...
  var miSlider = function (stageEl, options) {
    ...
    o.init = function (stageEl, options) {
      ...
      if (String(o.options.slideStart) === "beg") {
        ...
        $.isNumeric(o.options.slideStart) &&
      ...
      if (
        $.isNumeric(o.options.navButtonsOpacity) &&
      ...
      if (
        $.isNumeric(o.options.slideScaling) &&
        Number(o.options.slideScaling) >= 100
      ) {
      ...
      if (
        $.isNumeric(o.options.increment) &&
        parseInt(o.options.increment) !== 0
      ) {
    ...
    o.setup = function () {
      ...
      if (
        $.isNumeric(o.options.slideWidth) &&
        parseInt(o.options.slideWidth) > 0
      ) {
        o.slideWidthCurrent = parseInt(o.options.slideWidth);
      }
      if (
        $.isNumeric(o.options.stageHeight) &&
        parseInt(o.options.stageHeight) > 0
      ) {
      ...
      var slidesMaxNum =
        Math.floor(
          (o.stageWidth - o.slideWidthCurrent) /
            ((o.slideWidthCurrent * 100) / o.slideScaling)
        ) + 1;
      ...
      if (
        $.isNumeric(o.options.slidesOnStage) &&
      ...
      if (o.slidesOnStage > 1) {
        ...
        o.slideWidth =
          (o.stageWidth - o.slideWidthCurrent) / (o.slidesOnStage - 1);
      ...
      o.sliderWidth =
        o.slideWidthCurrent + o.slideWidth * (o.slidesLength - 1) + 1;
    ...
    o.transition = function (
      ...
      if (!o.animatedElements.is(":animated") && indexTo !== o.indexCurrent) {
        ...
        var indexDiff =
          o.normalizeIndex(indexToAdjusted) -
        ...
        if (indexDiff) {
            ...
            if (o.slideScaling !== 100) {
              ...
              if (o.options.centerV) {
                slideCurrentAdjusted
                  ...
                  .css(
                    "marginTop",
                    slideCurrentAdjusted.data("slideMarginTopCurrent")
                  );
              }
            }
            ...
            if (o.slideScaling !== 100) {
              ...
              if (o.options.centerV) {
                o.slideCurrent
                  .children()
                  .first()
                  .css("marginTop", o.slideCurrent.data("slideMarginTop"));
              }
            }
          ...
          if (o.navButtons) {
            ...
            o.navButtons.fadeTo(
              100,
              navButtonsFadeIn ? o.navButtonsOpacity : 0,
              function () {
                //  FadeOut Nav Buttons before move
                o.navButtons.fadeTo(
                  100,
                  0, //  FadeOut Nav Buttons before move
                  function () {
                    //  Do transition
                    o.animateSlides(indexToAdjusted, function () {
                      if (
                        o.stage.find(":hover").length ||
      ...
      navButtons
        ...
        .on("click", function (e) {
          ...
          if (this.className === o.classPrev) {
            o.autoplayOff();
            o.transition(
              o.indexCurrent - Math.abs(o.increment),
              false,
              o.autoplayOn(o.increment),
              true
            );
    ...
    o.addNavList = function () {
      ...
      o.slides.each(function (index) {
        ...
        var caption = $(this)
          ...
          .sort(function (a, b) {
            var aTag = $(a).prop("tagName"),
              bTag = $(b).prop("tagName");
            return (
              parseInt(aTag.match(/\d+/), 10) - parseInt(bTag.match(/\d+/), 10)
            );
          })
          .eq(0)
          .html();
        ...
        listHtml +=
          '<li><a href="#" title="' + itemText + '">' + itemText + "</a></li>";
      });
    ...
    o.leftOffset = function (index) {
      ...
      if (o.options.slidePosition === "center") {
        leftOffset =
          indexOffset + Math.floor(o.slidesOnStage / 2) * o.slideWidth;
    ...
    o.normalizeIndex = function (index) {
      index =
        ((index % o.slidesLengthOrig) + o.slidesLengthOrig) %
        o.slidesLengthOrig;
      return index;
    };
      ...
      o.slides.each(function (i) {
        ...
        if (o.options.centerV) {
          slide
            .children()
            .first()
            .css("marginTop", o.getMarginTop(slide, "slideMarginTop"));
        }
        ...
        if (i === o.indexCurrent) {
          ...
          if (o.options.centerV) {
            slide
              .children()
              .first()
              .css("marginTop", o.getMarginTop(slide, "slideMarginTopCurrent"));
          }
        }
      });
    };
